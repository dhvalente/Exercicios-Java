...
public class Repository {
    ...
    static void populaFitas() {
        ...
        Filme filme2 = new Filme("It, a Coisa", GeneroEnum.AVENTURA, FaixaEtariaEnum.PG_17);
        ...
        Filme filme16 = new Filme("Jogos Mortais", GeneroEnum.AVENTURA, FaixaEtariaEnum.R);
